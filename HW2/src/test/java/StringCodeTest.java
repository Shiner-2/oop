...
public class StringCodeTest {
	...
	@Test
	public void teststringIntersect_FalseCases() {
		assertEquals(false, StringCode.stringIntersect("abc123", "123cba", 4));
		assertEquals(false, StringCode.stringIntersect("123456", "lhikmn", 2));
	}
	@Test
	public void teststringIntersect_TrueCases() {
		assertEquals(true, StringCode.stringIntersect("abcdef", "fghjk", 1));
		assertEquals(true, StringCode.stringIntersect("abc123", "cba123", 3));
		assertEquals(true, StringCode.stringIntersect("123abc", "cba123", 3));
		assertEquals(true, StringCode.stringIntersect("123abc", "cba123acb", 3));
	}
}
